...
[✗] If it opens a page      → WRONG  
[✓] If it shows ONLY file   → CORRECT
...
➤ FINAL EXAMPLE:
  <img src="https://dl.dropboxusercontent.com/s/your_folder/image.jpg">


```▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```
❖ [3] PERFORMANCE BOOST (WITH EXAMPLE)(OPTIONAL)
```▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```
