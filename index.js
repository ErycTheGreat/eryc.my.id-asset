       ...
       let humanRewriter = new HTMLRewriter()
            ...
            .on("head", {
                element(e) {
                   ...
                   // 🤖 INJECT INTERACTION-TRIGGERED & PHANTOM AUTO-START (Layout Fixed)
                    const wakeUpScript = `
...
                                
                                // 🚀 ONLY trigger the background animation. 
                                // (Google Sites Framework stays asleep, fixing the scroll bug!)
...
                                
                                // 🛑 BLOCK 4: Lighthouse Mobile uses exactly 412px width
